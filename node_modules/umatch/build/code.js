...
* Version 0.2.0 - Compiled on 2014-11-13 05:11:05
...
var bundleFactory = function(minimatch, _) {
/**
...
define('minimatch',[],function () {
  if (__isNode) {
  return __nodeRequire('minimatch');
} else {
    return (typeof minimatch !== 'undefined') ? minimatch : __throwMissing('minimatch', 'minimatch')
}
});
define('umatch',['require', 'exports', 'module', 'minimatch'], function (require, exports, module) {
...
if (__isAMD) {
  return define(['minimatch', 'lodash'], bundleFactory);
} else {
    if (__isNode) {
        return module.exports = bundleFactory(require('minimatch'), require('lodash'));
    } else {
        return bundleFactory((typeof minimatch !== 'undefined') ? minimatch : void 0, (typeof _ !== 'undefined') ? _ : void 0);
    }
}
